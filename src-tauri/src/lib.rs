...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::cheat_runtime_cmd::cheat_runtime_orphans_list,
            commands::cheat_runtime_cmd::cheat_runtime_orphans_restore,
            commands::cheat_runtime_cmd::cheat_runtime_orphans_dismiss,
